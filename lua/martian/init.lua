local colors = require("martian.colors")
local config = require("martian.config")
local utils = require("martian.utils")
local bufferline = require("martian.integrations.bufferline")
local cmp = require("martian.integrations.cmp")
local theme = {}
...
function theme.colorscheme()
    if vim.version().minor < 8 then
        vim.notify("Neovim 0.8+ is required for martian colorscheme", vim.log.levels.ERROR, { title = "Min Theme" })
        return
    end
